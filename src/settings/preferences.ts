...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "tabs.mine": "我的",
    "schedule.title": "安排",
    "schedule.subtitlePending": "当前还有",
    "schedule.subtitlePendingSuffix": "条待跟进",
    "schedule.subtitleEmpty": "把待办、日程、提醒统一收纳",
    "schedule.add": "新建",
    "schedule.empty.title": "还没有任何安排",
    "schedule.empty.desc": "先手动记一条试试；AI 自动识别会在下一版接入。",
    "schedule.empty.cta": "新建第一条",
    "schedule.v1Hint": "V1：仅手动创建；AI 自动识别、合并与日历视图将在后续版本逐步接入。",
    "schedule.section.today": "今天",
    "schedule.section.upcoming": "未来",
    "schedule.section.untimed": "无具体时间",
    "schedule.section.later": "以后再说",
    "schedule.section.done": "已完成",
    "schedule.dueToday": "今天",
    "schedule.dueTomorrow": "明天",
    "schedule.dueYesterday": "昨天",
    "schedule.dueOverduePrefix": "已超期",
    "schedule.daysSuffix": "天",
    "schedule.daysLaterSuffix": "天后",
    "schedule.create.title": "新建安排",
    "schedule.create.titlePlaceholder": "记下要做的事，例如：后天去一趟医院",
    "schedule.create.timeLabel": "时间",
    "schedule.create.clearTime": "清除时间",
    "schedule.create.locationLabel": "地点",
    "schedule.create.locationPlaceholder": "例如：海淀医院",
    "schedule.create.peopleLabel": "相关人",
    "schedule.create.peoplePlaceholder": "例如：和爸爸、姐姐",
    "schedule.create.noteLabel": "备注",
    "schedule.create.notePlaceholder": "可以补充更多上下文",
    "schedule.create.submit": "保存",
    "schedule.create.cancel": "取消",
    "schedule.create.aiHint": "下一版接入大模型后，这条安排会自动从对话中识别和补全。",
    "schedule.action.complete": "标记完成",
    "schedule.action.undo": "撤销完成",
    "schedule.action.more": "更多操作",
    "schedule.action.later": "以后再说",
    "schedule.action.laterDesc": "暂时收起，不再出现在主列表里",
    "schedule.action.revive": "重新激活",
    "schedule.action.reviveDesc": "回到待跟进列表",
    "schedule.action.delete": "删除",
    "schedule.action.edit": "编辑",
    "schedule.action.editDesc": "修改标题、时间、人和地点",
    "schedule.hint": "「安排」会从你的输入、私聊、群聊等场景识别要做的事。AI 关闭时仍可手动创建。",
    "schedule.view.list": "列表",
    "schedule.view.calendar": "日历",
    "schedule.calendar.prev": "上个月",
    "schedule.calendar.next": "下个月",
    "schedule.calendar.weekdays": "日,一,二,三,四,五,六",
    "schedule.calendar.emptyDay": "这一天暂无安排",
    "schedule.timeKind.none": "不指定",
    "schedule.timeKind.due": "截止时间",
    "schedule.timeKind.range": "时间段",
    "schedule.timeKind.reminder": "提醒",
    "schedule.create.timeKindLabel": "时间类型",
    "schedule.create.dueLabel": "截止时间",
    "schedule.create.rangeLabel": "时间段",
    "schedule.create.reminderLabel": "提醒时间",
    "schedule.create.startShort": "开始",
    "schedule.create.endShort": "结束",
    "schedule.create.editTitle": "编辑安排",
    "schedule.create.executionLabel": "执行方式",
    "schedule.execution.manual": "人工完成",
    "schedule.execution.manualDesc": "需要用户线下处理，AI 不参与",
    "schedule.execution.assist": "AI 协助",
    "schedule.execution.assistDesc": "AI 先帮你准备好资料，再由你完成",
    "schedule.execution.auto": "AI 自动",
    "schedule.execution.autoDesc": "AI 可以直接帮你完成（查询、起草、翻译等）",
    "schedule.execute.cta": "AI 执行",
    "schedule.execute.running": "AI 处理中…",
    "schedule.execute.needsAi": "请先在「我的 → 设置 → AI 设置」启用 AI 并填好 API。",
    "schedule.tag.reminder": "提醒",
    "schedule.sourceCountSuffix": "条上下文",
    "schedule.sourceLabel.manual": "手动",
    "schedule.sourceLabel.self": "发给自己",
    "schedule.sourceLabel.private": "私聊",
    "schedule.sourceLabel.group": "群聊",
    "schedule.detail.note": "备注",
    "schedule.detail.sources": "相关对话上下文",
    "schedule.detail.sourcesEmpty": "暂无对话上下文",
    "schedule.detail.completionEvidence": "AI 判断完成依据",
    "schedule.detail.aiExecutionResult": "AI 执行结果",
    "schedule.aiBadge.on": "AI 已开启",
    "schedule.aiBadge.off": "AI 未开启",
    "schedule.aiBadge.demo": "AI 演示模式",
    "schedule.aiBadge.missingKey": "AI 未配置 API",
    "aiSettings.entryTitle": "AI 设置",
    "aiSettings.entryOff": "未开启 AI 识别",
    "aiSettings.entryConfigured": "已开启，使用你自己的 API",
    "aiSettings.entryMissingKey": "已开启，但未填写 API Key",
    "aiSettings.entryDemoActive": "已开启，使用本地演示模式",
    "aiSettings.title": "AI 设置",
    "aiSettings.enable": "开启 AI 识别",
    "aiSettings.enableDesc": "开启后，AI 会从你的发给自己 / 私聊 / 群聊消息识别安排，并消耗你自己的 token。",
    "aiSettings.provider": "模型供应商",
    "aiSettings.provider.openai": "OpenAI 兼容",
    "aiSettings.provider.anthropic": "Anthropic",
    "aiSettings.provider.demo-mock": "本地演示",
    "aiSettings.providerDesc.openai": "用于任何 OpenAI 兼容协议的接口，比如 OpenAI、DeepSeek、Moonshot、SiliconFlow 等。",
    "aiSettings.providerDesc.anthropic": "调用 Claude API（messages 接口）。需要支持浏览器直连或代理。",
    "aiSettings.providerDesc.demo-mock": "无需 API Key，使用本地启发式逻辑模拟识别效果，方便审阅者快速体验。",
    "aiSettings.apiKey": "API Key",
    "aiSettings.apiKeyPlaceholder": "粘贴你的 API Key（仅保存在本地）",
    "aiSettings.apiKeyDesc": "API Key 仅保存在本设备的 localStorage，不会被上传。每次调用都用你自己的额度。",
    "aiSettings.baseUrl": "Base URL",
    "aiSettings.model": "模型 ID",
    "aiSettings.groupScope": "群聊识别范围",
    "aiSettings.groupScope.self-only": "仅与我相关",
    "aiSettings.groupScope.all": "群内所有",
    "aiSettings.groupScopeDesc.self-only": "只处理 @我、提到我，或我自己发出的消息，避免把无关的群消息生成成我的安排。",
    "aiSettings.groupScopeDesc.all": "群里出现的可识别安排都会进入「安排」（适合工作群、家庭群）。",
    "aiSettings.test": "测试连接",
    "aiSettings.testing": "测试中…",
    "aiSettings.testOk": "测试通过，AI 已就绪。",
    "aiSettings.testFailed": "测试未通过，请检查 API 配置。",
    "aiSettings.missingKeyNotice": "请先填好 API Key。",
    "aiSettings.demoModeNotice": "本地演示模式已就绪。",
    "aiSettings.privacyNote": "本项目是候选人 Demo，所有 AI 调用都在浏览器内发起，密钥不会经过我们的服务器。如果你使用 Anthropic，可能需要服务端代理来绕过 CORS。",
    "search.close": "关闭搜索",
  ...
  "zh-TW": {
    ...
    "tabs.mine": "我的",
    "schedule.title": "安排",
    "schedule.subtitlePending": "目前還有",
    "schedule.subtitlePendingSuffix": "條待跟進",
    "schedule.subtitleEmpty": "把待辦、日程、提醒統一收納",
    "schedule.add": "新建",
    "schedule.empty.title": "還沒有任何安排",
    "schedule.empty.desc": "先手動記一條試試；AI 自動識別會在下一版接入。",
    "schedule.empty.cta": "新建第一條",
    "schedule.v1Hint": "V1：僅手動建立；AI 自動識別、合併與日曆視圖將在後續版本逐步接入。",
    "schedule.section.today": "今天",
    "schedule.section.upcoming": "未來",
    "schedule.section.untimed": "無具體時間",
    "schedule.section.later": "以後再說",
    "schedule.section.done": "已完成",
    "schedule.dueToday": "今天",
    "schedule.dueTomorrow": "明天",
    "schedule.dueYesterday": "昨天",
    "schedule.dueOverduePrefix": "已超期",
    "schedule.daysSuffix": "天",
    "schedule.daysLaterSuffix": "天後",
    "schedule.create.title": "新建安排",
    "schedule.create.titlePlaceholder": "記下要做的事，例如：後天去一趟醫院",
    "schedule.create.timeLabel": "時間",
    "schedule.create.clearTime": "清除時間",
    "schedule.create.locationLabel": "地點",
    "schedule.create.locationPlaceholder": "例如：海淀醫院",
    "schedule.create.peopleLabel": "相關人",
    "schedule.create.peoplePlaceholder": "例如：和爸爸、姐姐",
    "schedule.create.noteLabel": "備註",
    "schedule.create.notePlaceholder": "可以補充更多上下文",
    "schedule.create.submit": "儲存",
    "schedule.create.cancel": "取消",
    "schedule.create.aiHint": "下一版接入大模型後，這條安排會自動從對話中識別與補全。",
    "schedule.action.complete": "標記完成",
    "schedule.action.undo": "撤銷完成",
    "schedule.action.more": "更多操作",
    "schedule.action.later": "以後再說",
    "schedule.action.laterDesc": "暫時收起，不再出現在主列表裡",
    "schedule.action.revive": "重新啟用",
    "schedule.action.reviveDesc": "回到待跟進列表",
    "schedule.action.delete": "刪除",
    "schedule.action.edit": "編輯",
    "schedule.action.editDesc": "修改標題、時間、人和地點",
    "schedule.hint": "「安排」會從你的輸入、私聊、群聊等場景識別要做的事；關閉 AI 後仍可手動建立。",
    "schedule.view.list": "列表",
    "schedule.view.calendar": "日曆",
    "schedule.calendar.prev": "上個月",
    "schedule.calendar.next": "下個月",
    "schedule.calendar.weekdays": "日,一,二,三,四,五,六",
    "schedule.calendar.emptyDay": "這一天暫無安排",
    "schedule.timeKind.none": "不指定",
    "schedule.timeKind.due": "截止時間",
    "schedule.timeKind.range": "時間段",
    "schedule.timeKind.reminder": "提醒",
    "schedule.create.timeKindLabel": "時間類型",
    "schedule.create.dueLabel": "截止時間",
    "schedule.create.rangeLabel": "時間段",
    "schedule.create.reminderLabel": "提醒時間",
    "schedule.create.startShort": "開始",
    "schedule.create.endShort": "結束",
    "schedule.create.editTitle": "編輯安排",
    "schedule.create.executionLabel": "執行方式",
    "schedule.execution.manual": "人工完成",
    "schedule.execution.manualDesc": "需要你親自處理，AI 不參與",
    "schedule.execution.assist": "AI 協助",
    "schedule.execution.assistDesc": "AI 先幫你準備好資料，再由你完成",
    "schedule.execution.auto": "AI 自動",
    "schedule.execution.autoDesc": "AI 可以直接幫你完成（查詢、起草、翻譯等）",
    "schedule.execute.cta": "AI 執行",
    "schedule.execute.running": "AI 處理中…",
    "schedule.execute.needsAi": "請先在「我的 → 設定 → AI 設定」開啟 AI 並填好 API。",
    "schedule.tag.reminder": "提醒",
    "schedule.sourceCountSuffix": "條上下文",
    "schedule.sourceLabel.manual": "手動",
    "schedule.sourceLabel.self": "發給自己",
    "schedule.sourceLabel.private": "私聊",
    "schedule.sourceLabel.group": "群聊",
    "schedule.detail.note": "備註",
    "schedule.detail.sources": "相關對話上下文",
    "schedule.detail.sourcesEmpty": "暫無對話上下文",
    "schedule.detail.completionEvidence": "AI 判斷完成依據",
    "schedule.detail.aiExecutionResult": "AI 執行結果",
    "schedule.aiBadge.on": "AI 已開啟",
    "schedule.aiBadge.off": "AI 未開啟",
    "schedule.aiBadge.demo": "AI 演示模式",
    "schedule.aiBadge.missingKey": "AI 未配置 API",
    "aiSettings.entryTitle": "AI 設定",
    "aiSettings.entryOff": "未開啟 AI 識別",
    "aiSettings.entryConfigured": "已開啟，使用你自己的 API",
    "aiSettings.entryMissingKey": "已開啟，但未填寫 API Key",
    "aiSettings.entryDemoActive": "已開啟，使用本地演示模式",
    "aiSettings.title": "AI 設定",
    "aiSettings.enable": "開啟 AI 識別",
    "aiSettings.enableDesc": "開啟後，AI 會從你發給自己 / 私聊 / 群聊的訊息識別安排，並消耗你自己的 token。",
    "aiSettings.provider": "模型供應商",
    "aiSettings.provider.openai": "OpenAI 相容",
    "aiSettings.provider.anthropic": "Anthropic",
    "aiSettings.provider.demo-mock": "本地演示",
    "aiSettings.providerDesc.openai": "用於任何 OpenAI 相容協議的介面，比如 OpenAI、DeepSeek、Moonshot、SiliconFlow 等。",
    "aiSettings.providerDesc.anthropic": "呼叫 Claude API（messages 介面）。需要支援瀏覽器直連或代理。",
    "aiSettings.providerDesc.demo-mock": "無需 API Key，使用本地啟發式邏輯模擬識別效果，方便審閱者快速體驗。",
    "aiSettings.apiKey": "API Key",
    "aiSettings.apiKeyPlaceholder": "貼上你的 API Key（僅保存在本地）",
    "aiSettings.apiKeyDesc": "API Key 僅保存在本機 localStorage，不會被上傳。",
    "aiSettings.baseUrl": "Base URL",
    "aiSettings.model": "模型 ID",
    "aiSettings.groupScope": "群聊識別範圍",
    "aiSettings.groupScope.self-only": "僅與我相關",
    "aiSettings.groupScope.all": "群內所有",
    "aiSettings.groupScopeDesc.self-only": "只處理 @我、提到我，或我自己發出的訊息，避免把無關的群訊息變成我的安排。",
    "aiSettings.groupScopeDesc.all": "群內可識別的安排都會進入「安排」（適合工作群、家庭群）。",
    "aiSettings.test": "測試連線",
    "aiSettings.testing": "測試中…",
    "aiSettings.testOk": "測試通過，AI 已就緒。",
    "aiSettings.testFailed": "測試未通過，請檢查 API 設定。",
    "aiSettings.missingKeyNotice": "請先填好 API Key。",
    "aiSettings.demoModeNotice": "本地演示模式已就緒。",
    "aiSettings.privacyNote": "本專案是候選人 Demo，所有 AI 呼叫都在瀏覽器內發起，金鑰不會經過我們的伺服器。如果你使用 Anthropic，可能需要伺服端代理才能繞過 CORS。",
    "search.close": "關閉搜尋",
  ...
  "en-US": {
    ...
    "tabs.mine": "Me",
    "schedule.title": "Plans",
    "schedule.subtitlePending": "Still tracking",
    "schedule.subtitlePendingSuffix": "items",
    "schedule.subtitleEmpty": "Todos, schedules, and reminders in one place.",
    "schedule.add": "New",
    "schedule.empty.title": "No plans yet",
    "schedule.empty.desc": "Add one manually first. Smart capture from chats arrives in the next version.",
    "schedule.empty.cta": "Add your first plan",
    "schedule.v1Hint": "V1: manual create only. AI capture, merging, and calendar view will roll out in later versions.",
    "schedule.section.today": "Today",
    "schedule.section.upcoming": "Upcoming",
    "schedule.section.untimed": "No specific time",
    "schedule.section.later": "Later",
    "schedule.section.done": "Completed",
    "schedule.dueToday": "Today",
    "schedule.dueTomorrow": "Tomorrow",
    "schedule.dueYesterday": "Yesterday",
    "schedule.dueOverduePrefix": "Overdue",
    "schedule.daysSuffix": "d",
    "schedule.daysLaterSuffix": "d later",
    "schedule.create.title": "New plan",
    "schedule.create.titlePlaceholder": "Write down what to do, e.g. visit the clinic on Saturday",
    "schedule.create.timeLabel": "Time",
    "schedule.create.clearTime": "Clear time",
    "schedule.create.locationLabel": "Location",
    "schedule.create.locationPlaceholder": "e.g. Haidian Hospital",
    "schedule.create.peopleLabel": "People",
    "schedule.create.peoplePlaceholder": "e.g. Dad, sister",
    "schedule.create.noteLabel": "Note",
    "schedule.create.notePlaceholder": "Add more context if you want",
    "schedule.create.submit": "Save",
    "schedule.create.cancel": "Cancel",
    "schedule.create.aiHint": "After the next version connects to your LLM, plans will be auto-captured from your chats.",
    "schedule.action.complete": "Mark as done",
    "schedule.action.undo": "Undo done",
    "schedule.action.more": "More actions",
    "schedule.action.later": "Later",
    "schedule.action.laterDesc": "Quietly tuck away from the main list",
    "schedule.action.revive": "Reactivate",
    "schedule.action.reviveDesc": "Bring back to the active list",
    "schedule.action.delete": "Delete",
    "schedule.action.edit": "Edit",
    "schedule.action.editDesc": "Update title, time, people, and location",
    "schedule.hint": "Schedules can be captured from Send-to-self, private chats, and group chats. When AI is off, manual creation still works.",
    ...
    "schedule.calendar.weekdays": "Sun,Mon,Tue,Wed,Thu,Fri,Sat",
    "schedule.calendar.emptyDay": "No plans on this day yet",
    "schedule.timeKind.none": "No time",
    "schedule.timeKind.due": "Due time",
    "schedule.timeKind.range": "Time range",
    "schedule.timeKind.reminder": "Reminder",
    "schedule.create.timeKindLabel": "Time type",
    "schedule.create.dueLabel": "Due time",
    "schedule.create.rangeLabel": "Time range",
    "schedule.create.reminderLabel": "Reminder",
    "schedule.create.startShort": "From",
    "schedule.create.endShort": "To",
    "schedule.create.editTitle": "Edit plan",
    "schedule.create.executionLabel": "Execution mode",
    "schedule.execution.manual": "Manual",
    "schedule.execution.manualDesc": "You handle this yourself; AI stays out of the way.",
    "schedule.execution.assist": "AI assist",
    "schedule.execution.assistDesc": "AI prepares materials first, then you finish.",
    "schedule.execution.auto": "AI auto",
    "schedule.execution.autoDesc": "AI can complete the plan directly (lookups, drafting, translation).",
    "schedule.execute.cta": "Run with AI",
    "schedule.execute.running": "Running…",
    "schedule.execute.needsAi": "Enable AI under Me → Settings → AI first.",
    "schedule.tag.reminder": "Remind",
    "schedule.sourceCountSuffix": "linked",
    "schedule.sourceLabel.manual": "Manual",
    "schedule.sourceLabel.self": "Send-to-self",
    "schedule.sourceLabel.private": "Private chat",
    "schedule.sourceLabel.group": "Group chat",
    "schedule.detail.note": "Note",
    "schedule.detail.sources": "Linked context",
    "schedule.detail.sourcesEmpty": "No linked context yet",
    "schedule.detail.completionEvidence": "AI completion evidence",
    "schedule.detail.aiExecutionResult": "AI execution result",
    "schedule.aiBadge.on": "AI on",
    "schedule.aiBadge.off": "AI off",
    "schedule.aiBadge.demo": "AI demo",
    "schedule.aiBadge.missingKey": "AI key missing",
    "aiSettings.entryTitle": "AI settings",
    "aiSettings.entryOff": "AI capture is off",
    "aiSettings.entryConfigured": "On, using your own API",
    "aiSettings.entryMissingKey": "On, API key missing",
    "aiSettings.entryDemoActive": "On, local demo mode",
    "aiSettings.title": "AI settings",
    "aiSettings.enable": "Enable AI capture",
    "aiSettings.enableDesc": "AI will read your send-to-self, private, and group messages to capture plans. Calls use your own tokens.",
    "aiSettings.provider": "Provider",
    "aiSettings.provider.openai": "OpenAI-compatible",
    "aiSettings.provider.anthropic": "Anthropic",
    "aiSettings.provider.demo-mock": "Local demo",
    "aiSettings.providerDesc.openai": "Works with any OpenAI-compatible endpoint (OpenAI, DeepSeek, Moonshot, SiliconFlow…).",
    "aiSettings.providerDesc.anthropic": "Calls the Claude messages API. May need a proxy for browser CORS.",
    "aiSettings.providerDesc.demo-mock": "No API key needed. Uses local heuristics so reviewers can try the flow quickly.",
    "aiSettings.apiKey": "API key",
    "aiSettings.apiKeyPlaceholder": "Paste your API key (stored locally)",
    "aiSettings.apiKeyDesc": "The key only lives in this device's localStorage. Every call uses your own quota.",
    "aiSettings.baseUrl": "Base URL",
    "aiSettings.model": "Model",
    "aiSettings.groupScope": "Group chat scope",
    "aiSettings.groupScope.self-only": "Only related to me",
    "aiSettings.groupScope.all": "All group messages",
    "aiSettings.groupScopeDesc.self-only": "Only processes @me, mentions, or messages I sent. Avoids spamming plans from unrelated group chatter.",
    "aiSettings.groupScopeDesc.all": "Everything captured in the group becomes a plan (good for work/family groups).",
    "aiSettings.test": "Test connection",
    "aiSettings.testing": "Testing…",
    "aiSettings.testOk": "All good — AI is ready.",
    "aiSettings.testFailed": "Test failed. Check the API config.",
    "aiSettings.missingKeyNotice": "Add the API key first.",
    "aiSettings.demoModeNotice": "Local demo mode is ready.",
    "aiSettings.privacyNote": "This is a candidate Demo. All AI requests go straight from your browser; no key passes through our server. Anthropic typically needs a server-side proxy for CORS.",
